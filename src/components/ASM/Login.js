  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.inputContainer}>
        ...
        <Image source={require('../../media/images/EyeIcon.png')} style={styles.eyeIcon}></Image>
      </View>
      ...
      <Pressable style={styles.btnLogin}>
        <Text onPress={() => navigation.navigate('BottomNavigation')} style={styles.textLogin}>Login</Text>
      </Pressable>
      ...
      <View style={styles.signup}>
        ...
        <Text style={styles.text2} onPress={() => navigation.navigate('Register')}>Sign Up </Text>
      </View>
    </View>
  );
};
