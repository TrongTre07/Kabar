...
import React, {useState, useContext, createContext, ToastAndroid} from 'react';
  ...
  return (
    <View style={styles.container}>
      ...
      <TextInput
        ...
        value={email}
        style={styles.usernamePlace}></TextInput>
      ...
      <Pressable style={styles.btnLogin}>
        <Text onPress={handlerRegister} style={styles.textLogin}>Login</Text>
      </Pressable>
